...
package com.bitvalue.health.pickdatetime.view;
...
import com.bitvalue.health.pickdatetime.adapter.WheelAdapter;
...
public class WheelView extends View {
     ...
     */
    public WheelAdapter getViewAdapter() {
        return viewAdapter;
    }
    ...
    private void refreshTextStatus(View convertView, int old) {
        if (convertView == null) {
            return;
        }
