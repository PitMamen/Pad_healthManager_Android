 ...
 * @data :
 */
public class WaitVisitListAdapter extends BaseQuickAdapter<VisitBean, BaseViewHolder> {



    public WaitVisitListAdapter(int layoutResId, @Nullable List<VisitBean> data) {
