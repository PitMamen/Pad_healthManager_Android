...
//public class NewMsgFragment extends AppFragment implements BGASortableNinePhotoLayout.Delegate {
    ...
    public void initView(View rootView) {
        ...
        tv_add_audio = rootView.findViewById(R.id.tv_add_audio);
        tv_send_msg = rootView.findViewById(R.id.tv_send_msg);
        et_text_msg = rootView.findViewById(R.id.et_text_msg);
        layout_add_audio = rootView.findViewById(R.id.layout_add_audio);
        layout_add_video = rootView.findViewById(R.id.layout_add_video);
        layout_add_paper = rootView.findViewById(R.id.layout_add_paper);
        mRecordingGroup = rootView.findViewById(R.id.voice_recording_view);
        mRecordingIcon = rootView.findViewById(R.id.recording_icon);
        mRecordingTips = rootView.findViewById(R.id.recording_tips);
        list_audio = rootView.findViewById(R.id.list_audio);
