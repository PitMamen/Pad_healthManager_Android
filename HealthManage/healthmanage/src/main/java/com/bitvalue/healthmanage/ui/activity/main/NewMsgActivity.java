...
import com.bitvalue.healthmanage.http.api.SaveTotalMsgApi;
...
import com.bitvalue.healthmanage.ui.activity.media.ImageSelectActivity;
...
import static com.bitvalue.healthmanage.util.Constants.MAX_IMG;

public class NewMsgActivity extends AppActivity implements BGANinePhotoLayout.Delegate {
...
//    RecyclerView list_photos;
    ...
    private String msgType = Constants.MSG_SINGLE;
...
//        mIds = getArguments().getStringArrayList(Constants.MSG_IDS);
        ...
        tv_add_audio = findViewById(R.id.tv_add_audio);
        tv_send_msg = findViewById(R.id.tv_send_msg);
        et_text_msg = findViewById(R.id.et_text_msg);
        layout_add_audio = findViewById(R.id.layout_add_audio);
        layout_add_video = findViewById(R.id.layout_add_video);
        layout_add_paper = findViewById(R.id.layout_add_paper);
        ...
        list_audio = findViewById(R.id.list_audio);
        ...
        ninePhotoLayout.setDelegate(NewMsgActivity.this);
    ...
    private void initArticleListView() {
        list_articles.setLayoutManager(new LinearLayoutManager(NewMsgActivity.this));
        list_articles.addItemDecoration(MUtils.spaceDivider(
                DensityUtil.dip2px(NewMsgActivity.this, NewMsgActivity.this.getResources().getDimension(R.dimen.qb_px_3)), false));
...
//                this.switchSecondFragment(Constants.FRAGMENT_ARTICLE_DETAIL, articleBeans.get(position));
            }
        });
    ...
    private void initVideoListView() {
        list_videos.setLayoutManager(new LinearLayoutManager(NewMsgActivity.this));
        ...
        videoAdapter.setOnItemDelete(new OnItemDeleteCallback() {
            @Override
            public void onItemDelete(int position) {
    ...
    private void initAudioListView() {
        list_audio.setLayoutManager(new LinearLayoutManager(NewMsgActivity.this));
        list_audio.addItemDecoration(MUtils.spaceDivider(
                DensityUtil.dip2px(NewMsgActivity.this, NewMsgActivity.this.getResources().getDimension(R.dimen.qb_px_1)), false));
    ...
    public void checkPermission() {
        RxPermissions.getInstance(NewMsgActivity.this)
                    ...
                    public void call(Boolean flag) {
                        if (flag) {
                            if (!isRecording) {
                                ...
                                tv_add_audio.setTextColor(NewMsgActivity.this.getResources().getColor(R.color.orange));
                                AudioPlayer.getInstance().startRecord(new AudioPlayer.Callback() {
                                    @Override
                                    public void onCompletion(Boolean success) {
                                        tv_add_audio.setText("点击录音");
                                        tv_add_audio.setTextColor(NewMsgActivity.this.getResources().getColor(R.color.main_blue));
                                        isRecording = false;
                            ...
                            new AlertDialog.Builder(NewMsgActivity.this)
                                    ...
                                    .setPositiveButton("进入设置", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            Uri uri = Uri.fromParts("package", NewMsgActivity.this.getPackageName(), null);
                                            intent.setData(uri);
...
//                this.switchSecondFragment(Constants.FRAGMENT_ADD_VIDEO, addVideoObject);
                break;

            //可能需要检查权限，用带回调的封装的Utils.checkPermission
            case R.id.img_add_pic:
                PermissionUtils.checkPermission(NewMsgActivity.this, new PermissionUtils.PermissionCallBack() {
                    @Override
                    public void onPermissionResult(boolean permit) {
                        ...
                        ImageSelectActivity.start(NewMsgActivity.this, canSelectNun, new ImageSelectActivity.OnPhotoSelectListener() {
...
//                this.switchSecondFragment(Constants.FRAGMENT_ADD_PAPER, new GetMissionObj());
                break;
    ...
    private void uploadedAudioMsgs() {
        FileUploadUtils.INSTANCE.uploadAudio(NewMsgActivity.this, mUploadedAudios.get(i[0]), new FileUploadUtils.OnAudioUploadCallback() {
            @Override
    ...
    private void uploadedPicMsgs() {
        FileUploadUtils.INSTANCE.uploadPic(NewMsgActivity.this, mUploadImages.get(j[0]), new FileUploadUtils.OnAudioUploadCallback() {
            @Override
            public void onSuccess(ApiResult<AudioUploadResultBean> result) {
...
//                        chatInfo.setChatName(child.userName);
    ...
    public void onClickNinePhotoItem(BGANinePhotoLayout ninePhotoLayout, View view, int position, String model, List<String> models) {
        ...
        ImagePreviewActivity.start(this, model);
    }
