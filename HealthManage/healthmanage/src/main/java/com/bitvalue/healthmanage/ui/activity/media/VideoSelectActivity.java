...
import com.bitvalue.healthmanage.widget.view.StatusAction;
...
import com.bitvalue.healthmanage.widget.manager.ThreadPoolManager;
import com.bitvalue.healthmanage.widget.view.GridSpaceDecoration;
import com.bitvalue.healthmanage.widget.dialog.AlbumDialog;
import com.bitvalue.healthmanage.ui.adapter.VideoSelectAdapter;
import com.bitvalue.healthmanage.widget.view.StatusLayout;
...
public final class VideoSelectActivity extends AppActivity
    ...
    public static void start(BaseActivity activity, int maxSelect, OnVideoSelectListener listener) {
        ...
        intent.putExtra(Constants.AMOUNT, maxSelect);
        activity.startActivityForResult(intent, (resultCode, data) -> {
            ...
            ArrayList<VideoBean> list = data.getParcelableArrayListExtra(Constants.VIDEO);
    ...
    protected void initData() {
        // 获取最大的选择数
        mMaxSelect = getInt(Constants.AMOUNT, mMaxSelect);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.fab_video_select_floating) {
            ...
            // 完成选择
            setResult(RESULT_OK, new Intent().putParcelableArrayListExtra(Constants.VIDEO, mSelectVideo));
            finish();
        }
    }
