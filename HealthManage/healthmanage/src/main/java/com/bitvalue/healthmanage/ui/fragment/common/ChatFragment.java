package com.bitvalue.healthmanage.ui.fragment.common;
...
import com.bitvalue.healthmanage.http.api.ReportStatusApi;
...
//    更新就诊状态
    private void reportStatus(String status) {
        ...
        EasyHttp.post(AppApplication.instance().getHomeActivity()).api(reportStatusApi).request(new HttpCallback<ApiResult<ArrayList<VideoClientsResultBean>>>(AppApplication.instance().getHomeActivity()) {
            @Override
