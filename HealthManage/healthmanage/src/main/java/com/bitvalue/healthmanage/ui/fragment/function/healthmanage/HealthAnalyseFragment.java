...
import com.bitvalue.healthmanage.http.api.SaveAnalyseApi;
...
public class HealthAnalyseFragment extends AppFragment {
    ...
    protected void initView() {
        tv_title.setText(getString(R.string.health_analyse));
    ...
    private void commitTotalMsg() {
        ...
        EasyHttp.post(this).api(saveAnalyseApi).request(new HttpCallback<ApiResult<SaveAnalyseApi>>(this) {
            @Override
            ...
            @Override
            public void onSucceed(ApiResult<SaveAnalyseApi> result) {
                ...
                if (result.getCode() == 0) {
                    ...
                    message.title = getString(R.string.health_analyse);
...
//                    message.content = saveTotalMsgApi.remindContent;
                    ...
                    message.setDescription(getString(R.string.health_analyse_mes));
