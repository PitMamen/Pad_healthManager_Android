...
import com.bitvalue.healthmanage.http.api.GetCustomAnalyseApi;
...
//获取健康评估详情
    private void getMsgDetail() {//    /health/doctor/getUserRemind
        ...
        EasyHttp.get(this).api(getCustomAnalyseApi).request(new HttpCallback<ApiResult<SaveAnalyseApi>>(this) {
            @Override
            public void onStart(Call call) {
                super.onStart(call);
            }
