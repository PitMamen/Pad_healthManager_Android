...
import com.bitvalue.sdk.collab.helper.IBaseLiveListener;
import com.bitvalue.sdk.collab.helper.TUIKitLiveListenerManager;
...
import com.bitvalue.sdk.collab.utils.TUIKitUtils;
...
public class MessageNotification {
    ...
    private Context mContext = AppApplication.instance();
    ...
    private void createNotificationChannel(boolean isDialing) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (isDialing) {
                channel = new NotificationChannel(NOTIFICATION_CHANNEL_CALL, AppApplication.instance().getString(R.string.call_notification), NotificationManager.IMPORTANCE_HIGH);
                channel.setSound(RingtoneManager.getDefaultUri(RingtoneManager.TYPE_RINGTONE), null);
                channel.setDescription(AppApplication.instance().getString(R.string.background_tip));
                channel.setVibrationPattern(new long[]{0, 1000, 1000, 1000, 1000});
            } else {
                channel = new NotificationChannel(NOTIFICATION_CHANNEL_COMMON, AppApplication.instance().getString(R.string.new_msg_notification), NotificationManager.IMPORTANCE_HIGH);
                channel.setDescription(AppApplication.instance().getString(R.string.background_tip));
            }
    ...
    public void notify(V2TIMMessage msg) {
        ...
        String tickerStr = AppApplication.instance().getString(R.string.new_msg);
        ...
        if (isDialing) {
            launch = new Intent(mContext, HomeActivity.class);
            ...
            launch = new Intent(mContext, HomeActivity.class);//TODO 跳转聊天
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
                ...
                mHandler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        builder.setContentText(AppApplication.instance().getString(R.string.call_nos));
