package com.bitvalue.sdk.collab.modules.conversation.base;
...
import com.bitvalue.sdk.collab.component.gatherimage.SynthesizedImageView;
import com.bitvalue.sdk.collab.utils.ImageUtil;
...
public class ConversationIconView extends RelativeLayout {
    ...
    private static final int icon_size = ScreenUtil.getPxByDp(120);
