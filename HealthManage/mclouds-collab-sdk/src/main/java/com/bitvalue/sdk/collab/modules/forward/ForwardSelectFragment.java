...
import static com.bitvalue.sdk.collab.utils.TUIKitConstants.FORWARD_CREATE_GROUP_CODE;
import static com.bitvalue.sdk.collab.utils.TUIKitConstants.FORWARD_SELECT_MEMBERS_CODE;
            ...
            public void onItemClick(View view, int position, ConversationInfo conversationInfo) {
                ...
                if (position == 1){
                    ...
                    if(mTitleBarLayout.getLeftTitle().getText().equals(getString(R.string.titlebar_cancle))){
                        ...
                        startActivityForResult(intent, FORWARD_SELECT_MEMBERS_CODE);
