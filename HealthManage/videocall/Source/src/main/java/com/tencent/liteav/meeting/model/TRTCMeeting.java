...
public abstract class TRTCMeeting {
     ...
     */
    public abstract void createMeeting(String roomId, TRTCMeetingCallback.ActionCallback callback);
     ...
     * @param callback 创建房间的结果回调，成功时 code 为0.
     */
    public abstract void destroyMeeting(TRTCMeetingCallback.ActionCallback callback);
     ...
     */
    public abstract void enterMeeting(String roomId, TRTCMeetingCallback.ActionCallback callback);
     ...
     *                   适应（画面可能会有黑边）
     */
    public abstract void setLocalViewFillMode(int fillMode);
    ...
    //
    //////////////////////////////////////////////////////////
    public abstract void enableCustomVideoCapture(TRTCCloudListener.TRTCVideoRenderListener videoRenderListener);
    public abstract void disableCustomVideoCapture();
    public abstract void sendCustomVideoData(EGLContext eglContext, int textureId, int width, int height);
