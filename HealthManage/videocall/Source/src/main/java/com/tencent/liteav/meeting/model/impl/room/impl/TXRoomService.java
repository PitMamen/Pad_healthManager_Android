    ...
    public void createRoom(final String roomId, final String roomName, final String coverUrl, final TXCallback callback) {
        ...
        imManager.createGroup(V2TIMManager.GROUP_TYPE_MEETING, roomId, roomName, new V2TIMValueCallback<String>() {
            ...
            public void onError(int code, String s) {
                String msg = s;
                if (code == 10036) {
                    msg = mContext.getString(R.string.trtcmeeting_create_room_limit);
                }
                if (code == 10037) {
                    msg = mContext.getString(R.string.trtcmeeting_create_or_join_group_limit);
                }
                if (code == 10038) {
                    msg = mContext.getString(R.string.trtcmeeting_group_member_limit);
                }
                if (code == 10025) {
                    ...
                    V2TIMManager.getGroupManager().getGroupsInfo(Arrays.asList(roomId), new V2TIMValueCallback<List<V2TIMGroupInfoResult>>() {
                        ...
                        public void onSuccess(List<V2TIMGroupInfoResult> v2TIMGroupInfoResults) {
                            if (v2TIMGroupInfoResults != null && v2TIMGroupInfoResults.size() == 1) {
                                ...
                                Log.d(TAG, "Room " + groupInfo.getGroupID() + ", owner = " + groupInfo.getOwner());
                            }
                        }
