...
public class TXTRTCMeeting extends TRTCCloudListener {
    private static final String TAG = TXTRTCMeeting.class.getSimpleName();
    ...
    private void setVideoEncoderParam() {
        ...
        param.minVideoBitrate = mMeetingConfig.bitrate * 3 / 5;
        param.videoFps = mMeetingConfig.fps;
        param.enableAdjustRes = false;
        param.videoResolutionMode = TRTCCloudDef.TRTC_VIDEO_RESOLUTION_MODE_LANDSCAPE;
    ...
    public void setLocalViewFillMode(int fillMode) {
    ...
    public void setSpeaker(boolean useSpeaker) {
        ...
        mTRTCCloud.getDeviceManager().setAudioRoute(useSpeaker ? TXDeviceManager.TXAudioRoute.TXAudioRouteSpeakerphone : TXDeviceManager.TXAudioRoute.TXAudioRouteEarpiece);
    }
    ...
    public void enableCustomVideoCapture(TRTCCloudListener.TRTCVideoRenderListener videoRenderListener) {
        ...
        mTRTCCloud.setLocalVideoRenderListener(TRTCCloudDef.TRTC_VIDEO_PIXEL_FORMAT_Texture_2D,
                TRTCCloudDef.TRTC_VIDEO_BUFFER_TYPE_TEXTURE, videoRenderListener);
    }

    public void disableCustomVideoCapture() {
        mTRTCCloud.enableCustomVideoCapture(TRTCCloudDef.TRTC_VIDEO_STREAM_TYPE_BIG, false);
        mTRTCCloud.setLocalVideoRenderListener(TRTCCloudDef.TRTC_VIDEO_PIXEL_FORMAT_Texture_2D,
    ...
    public void sendCustomVideoData(EGLContext eglContext, int textureId, int width, int height) {
        // Log.d("XAVIER", "SendCustomVideoData: width = " + width + ", height = " + height);
